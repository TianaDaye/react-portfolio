...
const projects = [
  {
    ...
    problem: "Two RIT professors conducting NSF-funded research since 2020 had been simulating their causal mapping concept through tools like Lucidchart. They needed a purpose-built platform that could bring their research vision to life for real student use.",
    solution: "Commissioned to lead the full UI/UX design, I translated years of research and interview data into a functional webapp that allows students to create, explore, and document their career causal maps in an intuitive, research-grade environment."
  },
  {
  ...
  },
  {
    ...
    problem: "Mentors and mentees are forced to juggle multiple disconnected tools — Zoom, iMessage, Google Calendar, and more — just to maintain a single mentorship relationship. The friction makes meaningful mentorship harder to sustain.",
    solution: "As CEO and co-founder, I led the design of a unified platform that consolidates all mentorship needs in one place. YoungCrafters also allows existing mentorship programs to migrate onto the platform, create new programs, and support participants with guidebooks and dedicated liaisons — all free, because everyone deserves access to their full potential."
  },
  {
